...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/factures/edit/:id', name: 'facture', component: () => import('@/views/FactureEditView.vue'), props: true },
    { path: '/factures/create', name: 'factureCreate', component: () => import('@/views/FactureCreateView.vue') },
    { path: '/clients', name: 'clients', component: () => import('@/views/ClientsView.vue') },
    { path: '/clients/edit/:id', name: 'client', component: () => import('@/views/ClientEditView.vue'), props: true },
